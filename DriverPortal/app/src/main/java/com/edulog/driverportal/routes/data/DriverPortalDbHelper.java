...
public class DriverPortalDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ROUTE_ENTRY = "CREATE TABLE " + DriverPortalContract.RouteEntry.TABLE_NAME +
            ...
            DriverPortalContract.RouteEntry.COLUMN_NAME_UPDATED_AT + " TEXT NOT NULL, " +
            DriverPortalContract.RouteEntry.COLUMN_NAME_ORIGIN + " TEXT NOT NULL, " +
            DriverPortalContract.RouteEntry.COLUMN_NAME_DESTINATION + " TEXT NOT NULL)";
