...
public class SearchRoutesFragment extends BaseFragment implements SearchRoutesContract.View {
    ...
    public android.view.View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        android.view.View root = inflater.inflate(R.layout.fragment_search_routes, container, false);
